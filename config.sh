...
# ════════════════════════════════════════════════════════════
# موضع اللوجو - مُعدّل ليطابق موضع beIN SPORTS في الصورة
# ════════════════════════════════════════════════════════════
# 
# اللوجو سيظهر في أعلى اليمين، فوق شعار القناة مباشرة ✅
# بعد 10 بكسل من الحافة اليمنى، و 10 بكسل من الحافة العليا
#
LOGO_OFFSET_X="10"    # 10 بكسل من الحافة اليمنى (قريب جداً)
LOGO_OFFSET_Y="10"    # 10 بكسل من الحافة العليا (قريب جداً)
